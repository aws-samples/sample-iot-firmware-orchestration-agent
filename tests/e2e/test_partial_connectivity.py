"""End-to-end test for partial connectivity loss scenario.

Validates Requirement 9.3: Fleet of 50+ devices, connectivity loss in one
facility. Expected: PAUSE decisions followed by eventual completion or ROLLBACK.

This test requires a deployed stack. Run with:
    pytest tests/e2e/test_partial_connectivity.py -m e2e
"""
...
class TestPartialConnectivity:
    """E2E test: connectivity loss triggers execution that reaches terminal state."""
    ...
    def setup(self):
        ...
        # Register fleet with devices in different facilities
        self.thing_names = []
        ...
        for i in range(NUM_DEVICES):
            ...
            criticality = "LOW" if i < 25 else ("MEDIUM" if i < 40 else "HIGH")
